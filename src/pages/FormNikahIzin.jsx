...
export const FormNikahIzin = () => {
  ...
  const [getBinAyah, setBinAyah] = useState("");
  ...
  const [getBinIbu, setBinIbu] = useState("");
  ...
  const [getNamaPasangan, setNamaPasangan] = useState("");
  const [getBinPasangan, setBinPasangan] = useState("");
  const [getTempatPasangan, setTempatPasangan] = useState("");
  const [getTanggalPasangan, setTanggalPasangan] = useState("");
  const [getAgamaPasangan, setAgamaPasangan] = useState("");
  const [getPekerjaanPasangan, setPekerjaanPasangan] = useState("");
  const [getNIKPasangan, setNIKPasangan] = useState("");
  const [getAlamatPasangan, setAlamatPasangan] = useState("");
  ...
  const handleSubmit = () => {
    const data = {
      ...
      namaPasangan: getNamaPasangan,
      tempatPasangan: getTempatPasangan,
      lahirPasangan: getTanggalPasangan,
      agamaPasangan: getAgamaPasangan,
      pekerjaanPasangan: getPekerjaanPasangan,
      nikPasangan: getNIKPasangan,
      alamatPasangan: getAlamatPasangan,
    };
    ...
    <div>
      ...
      <div className="pt-28 pb-16 px-14">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="bin" className="font-medium">
              Nama Ayah
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setBinAyah(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="nik" className="font-medium">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setBinIbu(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="nik" className="font-medium">
          ...
          {/* DATA PASANGAN */}
          <div className="font-semibold">DATA PASANGAN (SUAMI / ISTRI)</div>
          <div className="flex flex-col gap-1">
            <label htmlFor="nama" className="font-medium">
              Nama Lengkap
            </label>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              id="bin"
              value={getBinPasangan}
              placeholder="Awali dengan huruf besar"
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setBinPasangan(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="nik" className="font-medium">
            ...
            <input
              type="number"
              id="nik"
              value={getNIKPasangan}
              placeholder="nik"
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setNIKPasangan(e.target.value)}
            />
          </div>
          <div className="w-full flex gap-3">
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                placeholder="Awali dengan huruf besar"
                id="lahir"
                value={getTempatPasangan}
                className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
                required
                onChange={(e) => setTempatPasangan(e.target.value)}
              />
            </div>
            <div className="flex flex-col gap-1 w-full">
              <label htmlFor="ttl" className="font-medium">
              ...
              <input
                type="date"
                id="ttl"
                value={getTanggalPasangan}
                placeholder="ttl"
                className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
                required
                onChange={(e) => setTanggalPasangan(e.target.value)}
              />
            </div>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              id="agama"
              value={getAgamaPasangan}
              placeholder="Awali dengan huruf besar"
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setAgamaPasangan(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="pekerjaan" className="font-medium">
            ...
            <input
              type="text"
              id="pekerjaan"
              value={getPekerjaanPasangan}
              placeholder="Awali dengan huruf besar"
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setPekerjaanPasangan(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="alamat" className="font-medium">
            ...
            <input
              type="text"
              id="alamat"
              value={getAlamatPasangan}
              placeholder="alamat"
              className="px-4 py-2 rounded-md border border-blue-300 focus:outline focus:outline-blue-500"
              required
              onChange={(e) => setAlamatPasangan(e.target.value)}
            />
          </div>
